# Pandoc GOST Template

Набор конфигураций и скриптов для автоматической верстки документов (курсовые, дипломы, статьи) в формат DOCX с соблюдением требований ГОСТ.

Проект оптимизирован для работы с текстами, сгенерированными LLM, исправляя типичные ошибки форматирования нейросетей.
...
> 2.  **Списки:** Обязательно оставляй пустую строку перед началом любого списка (маркированного или нумерованного), иначе он сольется с текстом при конвертации.
